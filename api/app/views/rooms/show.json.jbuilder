json.room do
  ...
  json.messages @room.messages do |message|
    ...
    json.user do
      ...
      json.custom_id message.user.custom_id
      json.email message.user.email
      json.birthday message.user.birthday
      json.spoken_language message.user.spoken_language
      json.learning_language message.user.learning_language
      json.residence message.user.residence
      json.introduction message.user.introduction
      json.created_at message.user.created_at
      json.updated_at message.user.updated_at
